...
namespace Spice_Test_One.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : Spice_Test_One.Controllers.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Spice_Test_One.Models.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(Spice_Test_One.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Spice_Test_One.Models.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(Spice_Test_One.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Spice_Test_One.Controllers.AccountController.ManageMessageId? message);

        public override System.Web.Mvc.ActionResult Manage(Spice_Test_One.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Spice_Test_One.Models.LocalPasswordModel model);

        public override System.Web.Mvc.ActionResult Manage(Spice_Test_One.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Spice_Test_One.Models.RegisterExternalLoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(Spice_Test_One.Models.RegisterExternalLoginModel model, string returnUrl)
        {
